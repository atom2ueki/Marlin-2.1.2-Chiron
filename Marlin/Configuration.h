...
#define CUSTOM_MACHINE_NAME "ATOM INDUSTRY"
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe.
...
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 40, 40, 200, 250 }
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 100, 400, 405 }
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 40, 50, 200, 202.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47.88, -7.5, 0 }
